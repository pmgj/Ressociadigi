...
public class ControladorApenado {
    ...
    public String listarApenadosFiltering(@RequestParam("searchBy") String searchBy, @RequestParam("value") String value, Model model
    		, @PageableDefault(page = 0, size = 2) Pageable pageable) {
    	
    	Page<Apenado> pgApenado;
    	
    	//Caso valor seja branco ou vazio, a ideia é que se torne null para evitar levantar exceção
    	//E consequentemente quebrar a aplicação. Pois a query pode ser feita com null, mas não com vazio
    	//Ou branco.
